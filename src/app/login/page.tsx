...
export default function LoginPage() {
  ...
  return (
    <div className="shell relative flex min-h-screen items-center justify-center bg-[#fff5fb] px-5 py-12">
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(900px_420px_at_10%_-10%,rgba(254,76,186,0.1),transparent_55%),radial-gradient(700px_360px_at_100%_0%,rgba(254,171,239,0.2),transparent_50%)]" />
